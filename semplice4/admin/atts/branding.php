	...
	'right' => array(
		...
		'scroll-reavel' => array(
			...
			'scroll_reveal' => array(
				...
				'help'			=> 'If this setting is \'Enabled\' the custom animations on the page will be disabled. Its not possible to run custom animations and scroll reveal at the same time.',
				'size'			=> 'span4',
				'data-input-type'    => 'select-box',
				'class'			=> 'editor-listen',
				'data-handler'	=> 'default',
