...
$gallery = array(
	...
	'Options' => array(
		...
		'cover_mode' => array(
			...
			'help' => 'If enabled your image gallery will be full width and full height like a cover.<br /><br /><b>Important:</b><br/>To make this work please make sure that you only have 1 column in your section and that your section width is set to fluid with no gutters.',
			'switch-type'=> 'twoway',
			'title'		 => 'Cover Mode',
			'size'		 => 'span2',
			'class'      		=> 'editor-listen',
