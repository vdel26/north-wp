...
function semplice_hide_on_init($post_id) {
	...
	// only remove the ide on init status is sr is disabled and if the static transitions are disabled or the post is not found
		...
		$form = '
			<div class="post-password-form">
				...
				<p>
					...
					<a class="post-password-submit semplice-event" data-event-type="helper" data-event="postPassword" data-id="' . $id . '">Enter</a>
				</p>
			</div>
		';
	} else {
